...
const snapshot = { project: { id: 7, name: "P", teamId: 1 }, generatedAt: "2026-08-24T11:00:00Z", consistency: "repeatable-read", devices: [], tracks: [], activeTasks: [], liveStreams: [], mediaPoints: [], suspectedConstruction: [], openAlerts: [], regions: [], freshness: { latestCapturedAt: null, isRealtime: true }, availability: {} } satisfies ProjectSituationSnapshot;
