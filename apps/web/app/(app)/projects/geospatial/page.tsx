...
import type { FlightHubGeospatialWorkspace } from "@/lib/dji-flighthub-geospatial-core";
...
export default function GeospatialPage() {
 return <StaticAPIPage<FlightHubGeospatialWorkspace> endpoint={query=>{const id=positiveParam(query);return id?`/api/projects/${id}/geospatial`:null;}}>{(workspace,query)=><Workspace workspace={workspace} projectId={Number(query.get("projectId"))}/>}</StaticAPIPage>;
}
function Workspace({ workspace, projectId }: { workspace: FlightHubGeospatialWorkspace; projectId:number }) {
