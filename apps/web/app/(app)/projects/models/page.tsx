...
import type { FlightHubModelsWorkspace } from "@/lib/dji-flighthub-models-core";
...
export default function ModelsPage() {
 return <StaticAPIPage<FlightHubModelsWorkspace> endpoint={query=>{const id=positiveParam(query);return id?`/api/projects/${id}/models`:null;}}>{(workspace,query)=><Workspace workspace={workspace} projectId={Number(query.get("projectId"))}/>}</StaticAPIPage>;
}
function Workspace({ workspace, projectId }: { workspace: FlightHubModelsWorkspace; projectId:number }) {
