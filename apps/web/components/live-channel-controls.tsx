...
export function LiveChannelControls({ projectId, device, activeStreamKeys = [], onStarted }: {
  projectId: number;
  device: ProjectSnapshotDevice;
  activeStreamKeys?: string[];
  onStarted: (session: Record<string, unknown> & { id: number; status: string }) => void | Promise<void>;
}) {
