...
import { DjiFlightHubControlledOperationsPanel } from "@/components/dji-flighthub-controlled-operations-panel";
...
export function DjiFlightHubConnections({
  ...
  return <div className="space-y-5">
    ...
    {selectedConnector && <section className="space-y-4 rounded-xl border p-4">
      ...
      <DjiFlightHubControlledOperationsPanel connectorId={selectedConnector.id} projectId={projectId} />
