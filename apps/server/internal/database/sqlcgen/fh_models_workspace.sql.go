...
// versions:
//   sqlc v1.31.1
// source: fh_models_workspace.sql
...
const readFHModelsAccess = `-- name: ReadFHModelsAccess :many
...
type ReadFHModelsAccessParams struct {
	UserID    int32 `json:"user_id"`
	ProjectID int32 `json:"project_id"`
}

func (q *Queries) ReadFHModelsAccess(ctx context.Context, arg ReadFHModelsAccessParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHModelsAccess, arg.UserID, arg.ProjectID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHModelsActions = `-- name: ReadFHModelsActions :many
SELECT to_jsonb(r) FROM (
select adapter.project_id::int as "projectId",adapter.id::text as "connectorId",policy.action,
      ...
      where adapter.project_id=$1 and adapter.team_id=$2 and definition.connector_key='dji.flighthub2'
) r
`

type ReadFHModelsActionsParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHModelsActions(ctx context.Context, arg ReadFHModelsActionsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHModelsActions, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHModelsConnectors = `-- name: ReadFHModelsConnectors :many
SELECT to_jsonb(r) FROM (
...
type ReadFHModelsConnectorsParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHModelsConnectors(ctx context.Context, arg ReadFHModelsConnectorsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHModelsConnectors, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHModelsJobs = `-- name: ReadFHModelsJobs :many
SELECT to_jsonb(r) FROM (
...
type ReadFHModelsJobsParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHModelsJobs(ctx context.Context, arg ReadFHModelsJobsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHModelsJobs, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHModelsResources = `-- name: ReadFHModelsResources :many
SELECT to_jsonb(r) FROM (
...
type ReadFHModelsResourcesParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHModelsResources(ctx context.Context, arg ReadFHModelsResourcesParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHModelsResources, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHModelsSync = `-- name: ReadFHModelsSync :many
SELECT to_jsonb(r) FROM (
...
type ReadFHModelsSyncParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHModelsSync(ctx context.Context, arg ReadFHModelsSyncParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHModelsSync, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
