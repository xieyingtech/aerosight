...
const readFHGeoAccess = `-- name: ReadFHGeoAccess :many
...
type ReadFHGeoAccessParams struct {
	UserID    int32 `json:"user_id"`
	ProjectID int32 `json:"project_id"`
}

func (q *Queries) ReadFHGeoAccess(ctx context.Context, arg ReadFHGeoAccessParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHGeoAccess, arg.UserID, arg.ProjectID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHGeoConnectors = `-- name: ReadFHGeoConnectors :many
SELECT to_jsonb(r) FROM (
...
type ReadFHGeoConnectorsParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHGeoConnectors(ctx context.Context, arg ReadFHGeoConnectorsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHGeoConnectors, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHGeoResources = `-- name: ReadFHGeoResources :many
SELECT to_jsonb(r) FROM (
...
type ReadFHGeoResourcesParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHGeoResources(ctx context.Context, arg ReadFHGeoResourcesParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHGeoResources, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHGeoSyncStates = `-- name: ReadFHGeoSyncStates :many
SELECT to_jsonb(r) FROM (
...
type ReadFHGeoSyncStatesParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHGeoSyncStates(ctx context.Context, arg ReadFHGeoSyncStatesParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHGeoSyncStates, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
