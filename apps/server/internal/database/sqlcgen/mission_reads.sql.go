...
const getMissionWorkbenchAudit = `-- name: GetMissionWorkbenchAudit :many
...
type GetMissionWorkbenchAuditParams struct {
	ProjectID int32 `json:"project_id"`
	ID        int32 `json:"id"`
}

func (q *Queries) GetMissionWorkbenchAudit(ctx context.Context, arg GetMissionWorkbenchAuditParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, getMissionWorkbenchAudit, arg.ProjectID, arg.ID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
