...
func (q *Queries) ListProjectIssues(ctx context.Context, projectID int32) ([]json.RawMessage, error) {
...
const readIssueAgents = `-- name: ReadIssueAgents :many
SELECT to_jsonb(r) FROM (
...
func (q *Queries) ReadIssueAgents(ctx context.Context, projectID int32) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readIssueAgents, projectID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readIssueAssets = `-- name: ReadIssueAssets :many
SELECT to_jsonb(r) FROM (
...
type ReadIssueAssetsParams struct {
	ProjectID int32 `json:"project_id"`
	IssueID   int32 `json:"issue_id"`
}

func (q *Queries) ReadIssueAssets(ctx context.Context, arg ReadIssueAssetsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readIssueAssets, arg.ProjectID, arg.IssueID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readIssueAssignees = `-- name: ReadIssueAssignees :many
SELECT to_jsonb(r) FROM (
...
type ReadIssueAssigneesParams struct {
	ProjectID int32 `json:"project_id"`
	IssueID   int32 `json:"issue_id"`
}

func (q *Queries) ReadIssueAssignees(ctx context.Context, arg ReadIssueAssigneesParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readIssueAssignees, arg.ProjectID, arg.IssueID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readIssueDetections = `-- name: ReadIssueDetections :many
SELECT to_jsonb(r) FROM (
...
type ReadIssueDetectionsParams struct {
	ProjectID int32 `json:"project_id"`
	IssueID   int32 `json:"issue_id"`
}

func (q *Queries) ReadIssueDetections(ctx context.Context, arg ReadIssueDetectionsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readIssueDetections, arg.ProjectID, arg.IssueID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readIssueDrafts = `-- name: ReadIssueDrafts :many
SELECT to_jsonb(r) FROM (
...
type ReadIssueDraftsParams struct {
	ProjectID int32         `json:"project_id"`
	IssueID   sql.NullInt32 `json:"issue_id"`
}

func (q *Queries) ReadIssueDrafts(ctx context.Context, arg ReadIssueDraftsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readIssueDrafts, arg.ProjectID, arg.IssueID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readIssueEvents = `-- name: ReadIssueEvents :many
SELECT to_jsonb(r) FROM (
...
type ReadIssueEventsParams struct {
	ProjectID int32 `json:"project_id"`
	IssueID   int32 `json:"issue_id"`
}

func (q *Queries) ReadIssueEvents(ctx context.Context, arg ReadIssueEventsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readIssueEvents, arg.ProjectID, arg.IssueID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readIssueLinks = `-- name: ReadIssueLinks :many
SELECT to_jsonb(r) FROM (
...
type ReadIssueLinksParams struct {
	ProjectID int32 `json:"project_id"`
	IssueID   int32 `json:"issue_id"`
}

func (q *Queries) ReadIssueLinks(ctx context.Context, arg ReadIssueLinksParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readIssueLinks, arg.ProjectID, arg.IssueID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readIssueMembers = `-- name: ReadIssueMembers :many
SELECT to_jsonb(r) FROM (
...
func (q *Queries) ReadIssueMembers(ctx context.Context, id int32) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readIssueMembers, id)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readProjectIssue = `-- name: ReadProjectIssue :one
SELECT to_jsonb(r) FROM (
...
type ReadProjectIssueParams struct {
	ProjectID int32 `json:"project_id"`
	ID        int32 `json:"id"`
}

func (q *Queries) ReadProjectIssue(ctx context.Context, arg ReadProjectIssueParams) (json.RawMessage, error) {
	row := q.db.QueryRowContext(ctx, readProjectIssue, arg.ProjectID, arg.ID)
	var to_jsonb json.RawMessage
