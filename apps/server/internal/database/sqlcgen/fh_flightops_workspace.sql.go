...
// versions:
//   sqlc v1.31.1
// source: fh_flightops_workspace.sql
...
const readFHFlightOpsAccess = `-- name: ReadFHFlightOpsAccess :many
...
type ReadFHFlightOpsAccessParams struct {
	UserID    int32 `json:"user_id"`
	ProjectID int32 `json:"project_id"`
}

func (q *Queries) ReadFHFlightOpsAccess(ctx context.Context, arg ReadFHFlightOpsAccessParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHFlightOpsAccess, arg.UserID, arg.ProjectID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHFlightOpsActions = `-- name: ReadFHFlightOpsActions :many
SELECT to_jsonb(r) FROM (
...
type ReadFHFlightOpsActionsParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHFlightOpsActions(ctx context.Context, arg ReadFHFlightOpsActionsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHFlightOpsActions, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHFlightOpsAlerts = `-- name: ReadFHFlightOpsAlerts :many
SELECT to_jsonb(r) FROM (
...
type ReadFHFlightOpsAlertsParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHFlightOpsAlerts(ctx context.Context, arg ReadFHFlightOpsAlertsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHFlightOpsAlerts, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHFlightOpsAssets = `-- name: ReadFHFlightOpsAssets :many
SELECT to_jsonb(r) FROM (
...
type ReadFHFlightOpsAssetsParams struct {
	ProjectID    int32  `json:"project_id"`
	TeamID       int32  `json:"team_id"`
	ResourceKind string `json:"resource_kind"`
}

func (q *Queries) ReadFHFlightOpsAssets(ctx context.Context, arg ReadFHFlightOpsAssetsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHFlightOpsAssets, arg.ProjectID, arg.TeamID, arg.ResourceKind)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHFlightOpsConnectors = `-- name: ReadFHFlightOpsConnectors :many
SELECT to_jsonb(r) FROM (
...
type ReadFHFlightOpsConnectorsParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHFlightOpsConnectors(ctx context.Context, arg ReadFHFlightOpsConnectorsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHFlightOpsConnectors, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHFlightOpsTaskRuns = `-- name: ReadFHFlightOpsTaskRuns :many
SELECT to_jsonb(r) FROM (
...
type ReadFHFlightOpsTaskRunsParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHFlightOpsTaskRuns(ctx context.Context, arg ReadFHFlightOpsTaskRunsParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHFlightOpsTaskRuns, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHFlightOpsTracks = `-- name: ReadFHFlightOpsTracks :many
SELECT to_jsonb(r) FROM (
...
type ReadFHFlightOpsTracksParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHFlightOpsTracks(ctx context.Context, arg ReadFHFlightOpsTracksParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHFlightOpsTracks, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const readFHFlightOpsWaylines = `-- name: ReadFHFlightOpsWaylines :many
SELECT to_jsonb(r) FROM (
...
type ReadFHFlightOpsWaylinesParams struct {
	ProjectID int32 `json:"project_id"`
	TeamID    int32 `json:"team_id"`
}

func (q *Queries) ReadFHFlightOpsWaylines(ctx context.Context, arg ReadFHFlightOpsWaylinesParams) ([]json.RawMessage, error) {
	rows, err := q.db.QueryContext(ctx, readFHFlightOpsWaylines, arg.ProjectID, arg.TeamID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
