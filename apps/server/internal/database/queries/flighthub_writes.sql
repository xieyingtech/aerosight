...
UPDATE device_adapters SET credential_envelope_json=$3::jsonb,discovery_scope_json=discovery_scope_json-'accountFingerprint',status='connecting',last_health_json='{}',last_checked_at=now(),updated_at=now()
