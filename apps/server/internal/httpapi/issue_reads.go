	...
	group.GET("/:issueId", func(c *gin.Context) {
		...
		s.scopedRead(c, func(q *sqlcgen.Queries, a sqlcgen.GetProjectAccessRow) (any, error) {
			...
			reads := []struct {
				...
				{"feedback", func() ([]json.RawMessage, error) {
					return q.ReadIssueFeedback(ctx, sqlcgen.ReadIssueFeedbackParams{ProjectID: pid, IssueID: iid})
				}},
				{"qualityStats", func() ([]json.RawMessage, error) { return q.ReadIssueQualityStats(ctx, pid) }},
