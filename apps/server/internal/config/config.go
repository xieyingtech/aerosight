...
func Load() (Config, error) {
	config := Config{
		...
		ObjectStorageLocalRoot: strings.TrimSpace(os.Getenv("DATA_DIR")),
		...
		AssetURLSigningSecret:  strings.TrimSpace(os.Getenv("APP_SECRET")),
		AuthSecret:             strings.TrimSpace(os.Getenv("APP_SECRET")),
