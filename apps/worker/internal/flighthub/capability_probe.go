...
var defaultCapabilityProbeEndpoints = []capabilityProbeEndpoint{
	...
	{ID: "456447011e0", Method: http.MethodGet, Path: "/openapi/v2.0/organizations", Scope: "global", Released: true, Regions: []string{"cn"}, Deployments: []string{"cn-public-cloud"}, CapabilityCodes: []string{"organization.read", "organization.project-member.write", "organization.write"}},
...
var defaultCapabilityReadiness = map[string]capabilityReadiness{
	...
	"organization.write":                {},
	"organization.project-member.write": {Implemented: true},
}
