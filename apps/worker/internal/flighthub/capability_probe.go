...
var defaultCapabilityProbeEndpoints = []capabilityProbeEndpoint{
	...
	{ID: "458069501e0", Method: http.MethodGet, Path: "/openapi/v2.0/device/{device_sn}/state", Scope: "device", Released: true, Regions: []string{"cn"}, Deployments: []string{"cn-public-cloud"}, CapabilityCodes: []string{"state.read"}, TemplateParameter: "device_sn"},
	...
	{ID: "457494965e0", Method: http.MethodGet, Path: "/openapi/v2.0/live-shares", Scope: "project", Profile: "live-share-list", Released: true, Regions: []string{"cn"}, Deployments: []string{"cn-public-cloud"}, CapabilityCodes: []string{"live.read", "live.control"}},
