...
const submitForm = async () => {
  ...
  try {
    ...
    toast.add({ severity: 'success', summary: '成功', detail: '组织创建成功', life: 3000 });
    ...
    toast.add({ severity: 'error', summary: '错误', detail: '创建组织失败', life: 3000 });
    console.error(error);
  }
};
  ...
  <DataTable :value="data ?? []" stripedRows>
    ...
    <Column header="操作">
      <template #body="slotProps">
        <Button icon="i-ri-pencil-line" text @click="editTeam(slotProps.data)" />
  ...
  >
    <div class="p-fluid">
      <div class="field mb-4">
        ...
        />
        <small v-if="submitted && !form.name" class="p-error">组织名称不能为空</small>
      </div>
