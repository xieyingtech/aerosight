...
import { dependencyHealthFromRecord, evaluateProjectHealth, type ProjectHealth } from "../../../apps/web/lib/dependency-health-core.ts";
import type { OperationDiagnostic } from "../../../apps/web/lib/operation-diagnostics-core.ts";
import { projectDeviceCapabilities, type DeviceCapabilityGrant, type ProjectedDeviceCapability } from "../../../apps/web/lib/device-action-projection.ts";
