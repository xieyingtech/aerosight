...
test("management API and UI do not expose remote ids, credentials, positions or controlled device serials",()=>{
  const service=readFileSync(new URL("./main-server/dji-flighthub-management.ts",import.meta.url),"utf8");
  const route=readFileSync(new URL("../../../apps/server/internal/httpapi/flighthub_workspace_reads.go",import.meta.url),"utf8");
  const component=readFileSync(new URL("../../../apps/web/components/dji-flighthub-management-panel.tsx",import.meta.url),"utf8");
