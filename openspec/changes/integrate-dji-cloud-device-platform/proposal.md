...
- 实现 DJI Cloud API Connector，覆盖 Dock 2 + Matrice 3D/3TD 与 Dock 3 + Matrice 4D/4TD 的自动发现、状态/遥测、能力映射、命令下发、回复关联、掉线与降级处理，并以同一连接器契约为后续 MQTT、ThingsBoard、AWS IoT Core、Azure IoT Hub、OPC UA 等平台保留扩展边界。
